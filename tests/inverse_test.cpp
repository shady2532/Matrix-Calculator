...
int main()
{
    ...
    // ========== BASIC INVERSE TESTS ==========
    cout << "========== BASIC INVERSE TESTS ==========" << endl << endl;
    
    // Test 1: Simple 2x2
    cout << "Test 1 - Simple 2x2 Inverse:" << endl;
    Matrix<double> A1 = {
        {4, 7},
        {2, 6}
    };
    ...
    Matrix<double> A1_inv = A1.inverse();
    cout << "Inverse A1^(-1):" << endl << A1_inv << endl;
    ...
    Matrix<double> A2_inv = A2.inverse();
    cout << "Inverse A2^(-1):" << endl << A2_inv << endl;
    cout << "Expected:" << endl;
    ...
    // Test 3: Identity matrix (inverse should be itself)
    ...
    cout << "Inverse A3^(-1):" << endl << A3_inv << endl;
    cout << "Is Identity? " << (isIdentity(A3_inv) ? "YES ✓" : "NO ✗") << endl << endl;
    
    // ========== 3x3 MATRICES ==========
    cout << "========== 3x3 INVERSE TESTS ==========" << endl << endl;
    ...
    Matrix<double> A4_inv = A4.inverse();
    cout << "Inverse A4^(-1):" << endl << A4_inv << endl;
    ...
    Matrix<double> A5_inv = A5.inverse();
    cout << "Inverse A5^(-1):" << endl << A5_inv << endl;
    ...
    Matrix<double> A6_inv = A6.inverse();
    cout << "Inverse A6^(-1):" << endl << A6_inv << endl;
    cout << "Expected:" << endl;
    ...
    Matrix<double> A7_inv = A7.inverse();
    cout << "Inverse A7^(-1):" << endl << A7_inv << endl;
    ...
    Matrix<double> A8_inv = A8.inverse();
    cout << "Inverse A8^(-1):" << endl << A8_inv << endl;
    ...
    // ========== 4x4 MATRICES ==========
    cout << "========== 4x4 INVERSE TESTS ==========" << endl << endl;
    ...
    Matrix<double> A9_inv = A9.inverse();
    cout << "Inverse A9^(-1):" << endl << A9_inv << endl;
    ...
    Matrix<double> A10_inv = A10.inverse();
    cout << "Inverse A10^(-1):" << endl << A10_inv << endl;
    ...
    Matrix<double> A11_inv = A11.inverse();
    cout << "Inverse A11^(-1):" << endl << A11_inv << endl;
    ...
    Matrix<double> A12_inv = A12.inverse();
    cout << "Inverse A12^(-1):" << endl << A12_inv << endl;
    ...
    try {
        Matrix<double> A13_inv = A13.inverse();
    ...
    try {
        Matrix<double> A14_inv = A14.inverse();
        cout << "ERROR: Should have thrown exception! ✗" << endl << endl;
    } catch (const runtime_error& e) {
        cout << "Correctly threw exception: " << e.what() << " ✓" << endl << endl;
    }
    ...
    cout << "Test 15 - Cached Inverse:" << endl;
    Matrix<double> A15 = {
        {3, 1},
        {2, 4}
    };
    ...
    Matrix<double> A15_inv1 = A15.inverse();
    auto end1 = chrono::high_resolution_clock::now();
    auto duration1 = chrono::duration_cast<chrono::microseconds>(end1 - start1);
    
    cout << "First inverse call (computes): " << duration1.count() << " μs" << endl;
    cout << A15_inv1 << endl;
    
    // Second call - cached
    auto start2 = chrono::high_resolution_clock::now();
    Matrix<double> A15_inv2 = A15.inverse();
    auto end2 = chrono::high_resolution_clock::now();
    auto duration2 = chrono::duration_cast<chrono::microseconds>(end2 - start2);
    
    cout << "Second inverse call (cached): " << duration2.count() << " μs" << endl;
    cout << A15_inv2 << endl;
    ...
    Matrix<double> A17_inv = A17.inverse();
    cout << "Inverse A17^(-1):" << endl << A17_inv << endl;
